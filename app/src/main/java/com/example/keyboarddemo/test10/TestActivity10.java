package com.example.keyboarddemo.test10;
 ...
 * H5页面软键盘弹出H5上移
 */
public class TestActivity10 extends AppCompatActivity implements View.OnClickListener, MyFrameLayout.OnLayoutListener {
