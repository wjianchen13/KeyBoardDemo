package com.example.keyboarddemo.test9;
 ...
 * H5页面软键盘弹出H5上移
 */
public class TestActivity9 extends AppCompatActivity implements View.OnClickListener, MyFrameLayout.OnLayoutListener {
