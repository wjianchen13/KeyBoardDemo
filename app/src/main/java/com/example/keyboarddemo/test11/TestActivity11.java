package com.example.keyboarddemo.test11;
 ...
 * H5页面软键盘弹出H5上移
 */
public class TestActivity11 extends AppCompatActivity implements View.OnClickListener, MyFrameLayout.OnLayoutListener {
