package com.example.keyboarddemo.test12;
 ...
 * H5页面软键盘弹出H5上移
 */
public class TestActivity12 extends AppCompatActivity implements View.OnClickListener, MyFrameLayout.OnLayoutListener {
